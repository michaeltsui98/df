...
class IndexController extends Cola_Controller
{
    ...
    public function __construct(){
        parent::__construct();
        Cola::loadClass('IndexModel','models');
...
//         $this->response->lastModified(1252376412);
    ...
    public function pagerAction()
    {
        ...
        $page = new Cola_Com_Pager($p, 20, 268, '/demo/index.php/index/pager/p/%page%/');
    ...
    public function yamlAction()
    {
        $data = array(
            ...
            2 => array('t' => 'rdo', 'd' => array('菁华 （qīng）    宁可（nìng）   冠心病（guān）  翘首回望（qiáo）', 'Bar', 'FooBar')),
            3 => array('t' => 'txt', 'd' => 'bar')
        );
