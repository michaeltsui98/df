...
(function () {
	...
	//sasou
	var ADMIN_URL = "http://172.16.3.21/app/syxue/1/manage/";
	var attach_URL = "http://dev-images.dodoedu.com/xueimage/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:ADMIN_URL+"editor-baidu_up.htm"             //图片上传提交地址
        ,imagePath:attach_URL                       //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //图片在线管理配置区
        ,imageManagerUrl:ADMIN_URL+"editor-baidu_manage.htm"       //图片在线管理的处理地址
        ,imageManagerPath:attach_URL                               //图片修正地址，同imagePath
		...
		*/
		,toolbars: [
            ['morefunction', 'fullscreen', 'undo', 'redo', 'bold', 'italic', 'underline', 'inserttiankong', 'insertimage','music', 'm','spechars','fontfamily','fontsize', 'forecolor', 'backcolor', 'removeformat', 'link', 'emotion', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', 'insertorderedlist', 'insertunorderedlist', 'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'splittocols']
        ]
